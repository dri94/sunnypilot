...
from openpilot.system.manager.process_config import NETWORK_MODE_PRIVACY, get_network_mode
...
def init(project: SentryProject) -> bool:
  ...
  params = Params()
  if get_network_mode(params) >= NETWORK_MODE_PRIVACY:  # Privacy or Offline
    return False
